...
echo "=== PVE XPU Plugin Smoke Tests (via serial) ==="
echo ""
...
run_test "Nodes.pm patch applied" "grep -q XPU /usr/share/perl5/PVE/API2/Nodes.pm"
run_test "Systemd service enabled" "systemctl is-enabled pve-xpu-sriov.service"
run_test "Perl module loads" "perl -I/usr/share/perl5 -MPVE::API2::Hardware::XPU -e 1"
...
run_test "Config file exists" "test -f /etc/pve/local/xpu-sriov.conf"
...
run_test "Perl module removed" "test ! -f /usr/share/perl5/PVE/API2/Hardware/XPU.pm"
run_test "JS patch reverted" "! grep -q pve-xpu-plugin /usr/share/pve-manager/index.html.tpl"
run_test "Nodes.pm patch reverted" "! grep -q XPU /usr/share/perl5/PVE/API2/Nodes.pm"
